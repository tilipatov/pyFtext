...
def c_dic(text): # Словарь с цветовым форматированием 
	dic_color = {
	'black':'\x1b[30m'+str(text)+'\x1b[0m',
	'red':'\x1b[31m'+str(text)+'\x1b[0m',
	'green':'\x1b[32m'+str(text)+'\x1b[0m',
	'yellow':'\x1b[33m'+str(text)+'\x1b[0m',
	'blue':'\x1b[34m'+str(text)+'\x1b[0m',
	'purple':'\x1b[35m'+str(text)+'\x1b[0m',
	'lblue':'\x1b[36m'+str(text)+'\x1b[0m',
	'white':'\x1b[37m'+str(text)+'\x1b[0m',
	}
	return dic_color
...
def black(text): # Чёрный
	out = '\x1b[30m'+str(text)+'\x1b[0m'
	return out

def red(text): # Красный
	out = '\x1b[31m'+str(text)+'\x1b[0m'
	return out

def green(text): # Зелёный
	out = '\x1b[32m'+str(text)+'\x1b[0m'
	return out	

def yellow(text): # Жёлтый
	out = '\x1b[33m'+str(text)+'\x1b[0m'
	return out	

def blue(text): # Синий
	out = '\x1b[34m'+str(text)+'\x1b[0m'
	return out			

def purple(text): # Пурпурный
	out = '\x1b[35m'+str(text)+'\x1b[0m'
	return out	

def lblue(text): # Голубой
	out = '\x1b[36m'+str(text)+'\x1b[0m'
	return out

def white(text): # Белый
	out = '\x1b[37m'+str(text)+'\x1b[0m'
	return out		
